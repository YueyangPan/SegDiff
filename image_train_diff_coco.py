...
from datasets.coco import load_data, create_dataset
...
def main():
    ...
    exp_name = f"coco_{args.rrdb_blocks}_{args.lr}_{args.batch_size}_{args.diffusion_steps}_{str(args.dropout)}_{args.class_name}_{MPI.COMM_WORLD.Get_rank()}"
    if args.expansion:
        exp_name += "_expansion"
